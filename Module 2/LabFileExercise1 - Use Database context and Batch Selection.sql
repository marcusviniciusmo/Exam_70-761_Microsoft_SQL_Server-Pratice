...
---------------------------------------------------------------------
	...
	Using SQL Server Management Studio (SSMS), connect to MIA-SQL using Windows authentication.
...
---------------------------------------------------------------------
	...
	Observe the result.
	You should get the same result as in Task 2.
	Tip: One way to highlight a portion of code is to hold down the Alt key
	while drawing a rectangle around it with your mouse.
	The code inside the draw rectangle will be selected. Try it.
*/