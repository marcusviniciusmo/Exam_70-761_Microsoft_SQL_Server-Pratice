...
-- Step 2: Using functions. Select and execute the following to demonstrate using the sample function.
-- Note: dbo.GetNums() takes as parameters: @low (bigint) and @high (bigint)

SELECT *
FROM dbo.GetNums(10, 20);
GO

-- Step 3a: Creating simple functions. Select and execute the following to create a function to calculate line extension for orders.
